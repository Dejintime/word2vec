...
train = pd.read_csv("./data/labeledTrainData.tsv/labeledTrainData.tsv", header=0,
                    delimiter="\t", quoting=3)
test = pd.read_csv("./data/testData.tsv/testData.tsv", header=0,
                   delimiter="\t", quoting=3)
unlabeled_train = pd.read_csv("./data/unlabeledTrainData.tsv/unlabeledTrainData.tsv", header=0,
                              delimiter="\t", quoting=3)
...
if __name__ == '__main__':
    ...
    wvmodel_file = os.path.join("f:\\", 'nlp', 'glove_lib', 'glove.840B.300d.gensim.txt')
